...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl lg:text-5xl font-semibold text-gray-900 leading-tight pr-8">
                  Schadenmanagement.
                  <br />
                  Digital. Effizient.
                </h1>
            ...
            <div className="relative h-[600px] lg:h-[700px] rounded-2xl overflow-hidden">
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-vvrRAyHKcL0Hkn4Awu5AuHDDqhoOhh.png"
      ...
      <section id="warum" className="bg-gray-50 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 space-y-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-sm font-bold text-gray-900">Offene API</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 space-y-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Großes Netzwerk qualifizierter Experten für schnelle Verfügbarkeit
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Statistics Section */}
      <section className="bg-[#1a1f2e] py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
      ...
      <section id="funktionen" className="bg-white py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          {/* Section Header */}
          <div className="text-center mb-16 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-10 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-sm text-gray-700">Mandantenfähigkeit</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-sm text-gray-700">Single Sign-On (SSO)</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-gray-400">•</span>
            ...
            <div className="bg-gray-50 rounded-2xl p-10 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-gray-400">•</span>
                  <span className="text-sm text-gray-700">ISO-zertifizierte Infrastruktur</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="module" className="bg-gray-50 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          {/* Section Header */}
          <div className="text-center mb-16 space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
              ...
              <div className="relative h-64 w-full">
                <Image
                  src="/car-accident-damaged-vehicles.jpg"
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
              ...
              <div className="relative h-64 w-full">
                <Image
                  src="/brick-residential-house-building.jpg"
                  alt="Sachverständige"
                  fill
                  className="object-cover"
                />
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
              ...
              <div className="relative h-64 w-full">
                <Image
                  src="/person-working-on-laptop-with-documents-profession.jpg"
                  alt="Betrugsmittlung"
                  fill
                  className="object-cover"
                />
      ...
      <section id="integration" className="bg-[#1a1f2e] py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-white">Offene API</h3>
      ...
      <section id="prozess" className="bg-white py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          {/* Section Header */}
      ...
      <section id="referenzen" className="bg-gray-50 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          {/* Section Header */}
          <div className="flex items-start justify-between mb-16">
            ...
            <div className="flex gap-3">
              <button className="w-12 h-12 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-teal-600 hover:text-teal-600 transition-colors">
                <ChevronLeft className="h-5 w-5" />
              </button>
              <button className="w-12 h-12 rounded-full border-2 border-teal-600 text-teal-600 flex items-center justify-center hover:bg-teal-600 hover:text-white transition-colors">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 space-y-6 shadow-sm">
              ...
              <p className="text-base text-gray-900 leading-relaxed">
                "With Claimity, we have reduced our processing time by 40%. The automatic assignment and constant
                availability of qualified experts saves us hours every day."
              </p>
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
                  <Image src="/professional-man-glasses.png" alt="Amin Gerber" fill className="object-cover" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-8 space-y-6 shadow-sm">
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
                  <Image
                    src="/professional-man-business-executive.jpg"
                    alt="Toni Tulliani"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="bg-white rounded-2xl p-8 space-y-6 shadow-sm">
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-12 h-12 rounded-full overflow-hidden flex-shrink-0">
                  <Image src="/professional-business-woman.png" alt="Tracy Borer" fill className="object-cover" />
                </div>
                <div>
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <Accordion type="single" collapsible className="space-y-0">
            ...
            <AccordionItem value="item-7" className="border-b border-gray-200">
              ...
              <AccordionContent className="text-base text-gray-700 leading-relaxed pb-6">
                Transparente Preisgestaltung: Monatliche Plattformgebühr plus variable Kosten pro bearbeitetem Fall.
                Keine versteckten Kosten. Detaillierte Abrechnungsberichte stehen jederzeit im Dashboard zur Verfügung.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section className="bg-gray-50 py-20 lg:py-32">
        <div className="mx-auto max-w-7xl px-6">
          {/* CHANGE: Updated background color from #2d5f5d to #194D50 */}
          <div className="bg-[#194D50] rounded-3xl px-12 py-16 lg:py-20">
